...
mod stark;
pub use stark::{ProofOptions, StarkProof};
...
pub fn execute(
    ...
    let mut trace =
        stark::TraceTable::new(trace, ctx_depth, loop_depth, options.extension_factor());
    debug!(
    ...
    assert!(
        last_state.op_counter() as usize >= MIN_TRACE_LENGTH,
